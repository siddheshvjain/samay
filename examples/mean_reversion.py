"""
Mean Reversion Strategy Example (RSI-based)
=============================================
Buys when RSI drops below oversold threshold (30).
Sells when RSI rises above overbought threshold (70).

RSI (Relative Strength Index) measures momentum. Extreme readings
...
- Single, liquid tickers (SPY, large caps)
...
class RSIMeanReversionStrategy(Strategy):
    ...
    description = "RSI-based mean reversion: buy < 30, sell > 70"
    author = "samay-core"
    version = "1.0.0"
